...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('arena_sessions', function (Blueprint $table) {
            ...
            // PDF: started_by/ended_by referenciam therapists, não users
            $table->foreignId('started_by')->constrained('therapists')->onDelete('restrict');
            $table->foreignId('ended_by')->nullable()->constrained('therapists')->onDelete('set null');
